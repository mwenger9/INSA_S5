...
class FenetreMDI(QMainWindow):
    ...
    def changerFenetre(self):
        ...
        if fille and (isinstance(fille,FenetreFilleRGB) or isinstance(fille,FenetreFilleTC)):
            ...
            if isinstance(fille,FenetreFilleRGB):
                ...
                self.actionSatureRouge.setEnabled(True)
    ...
    def ajoutMenuTraitements24Bits(self):
        ...
        # A compléter pour la question 8...
        self.actionSatureRouge = self.ajoutChoixMenu("&Saturer en rouge",self.menuTraitements24b,self.saturationClicked,"saturerRouge.png")
        # self.actionSaturerRouge, "&Saturer en rouge", "saturerRouge.png", saturationClicked
    ...
    def ajoutToolBar(self):
        ...
        # A compléter pour la question 8...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionSatureRouge)
        self.toolBar.addSeparator()
