...
public class Color extends java.awt.Color {
	...
	public String toString() {
		final Object[] colors = {
			new Integer(this.getRed()),
			new Integer(this.getGreen()),
			new Integer(this.getBlue()),
			new Integer(this.getAlpha()),
		};
	 ...
	 * @return A new color composed by the distances between each components
	 ...
	 * @return true if the distances between each components of the colors are
